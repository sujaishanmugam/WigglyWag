...
const Header = () => {
  ...
  const [navStyle, setNavStyle] = useState("text-black");
    ...
    >
      <div className="container">
        <Link className="navbar-brand" to="/" style={{ color: "#15D1C8" }}>
          ...
          <span className="logo-name"> Wiggly Wag </span>
        </Link>
        <button
        ...
        >
          <ul className="navbar-nav ml-auto mt-2 mt-lg-0">
            ...
            <li className="nav-item" style={{ color: "#15D1C8" }}>
              <Link 
